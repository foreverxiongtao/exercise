...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(CoreUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(CoreUtils.getApp().getPackageManager()) == null ||
                CoreUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivityForResult(@NonNull final Class<?> clz,int requestCode) {
        Activity activity = (Activity) getActivityOrApp();
     ...
     */
    public static void startNewActivity(@NonNull final Class<?> clz,
                                        @NonNull final Bundle bundle) {
        Context context = getActivityOrApp();
        Intent intent = new Intent();
        intent.setClass(context, clz);
        startNewActivity(intent, context, bundle);
    }
    ...
    public static List<Activity> getActivityList() {
        return CoreUtils.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(CoreUtils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        PackageManager pm = CoreUtils.getApp().getPackageManager();
    ...
    public static Activity getTopActivity() {
        if (CoreUtils.sTopActivityWeakRef != null) {
            Activity activity = CoreUtils.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = CoreUtils.sActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = CoreUtils.sActivityList;
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(CoreUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clz) {
        return getActivityLogo(new ComponentName(CoreUtils.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? CoreUtils.getApp() : topActivity;
    }
    ...
    private static void startNewActivity(final Intent intent,
                                         final Context context,
                                         final Bundle bundle) {
        if (!(context instanceof Activity)) {
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
